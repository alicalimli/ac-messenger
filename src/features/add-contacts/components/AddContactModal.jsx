  ...
  return (
            <div className="flex flex-col gap-4 py-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <TwTrnButton clickHandler={cancelBtnHandler} addClass="w-full flex justify-center border border-muted-light/50 dark:border-muted-dark/50 py-1">Cancel</TwTrnButton>
              </div>
            </div>
  );
};
